                      ...
                      <div className="display-table-cell vertical-align-middle">
                          ...
                          <div className="social-icon-style-8 display-inline-block vertical-align-middle">
                              <ul className="small-icon no-margin-bottom">
                                  <li><a className="google text-white" href="https://www.linkedin.com/in/carlo-bilbao/" target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin accent-hover"></i></a></li>
