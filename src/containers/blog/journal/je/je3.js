...
const je3 = () => {
  return (
    <div>
        ...
        <section className="wow fadeIn cover-background background-position-top" style ={ { backgroundImage: "url(http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-hero.jpeg)" } }>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure className="wp-caption alignright"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a1.jpeg" alt=""/><figcaption className="wp-caption-text">And lots of it</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure className="wp-caption alignleft"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a2.jpeg" alt=""/><figcaption className="wp-caption-text">Yahoo isn&#39;t playing around when it come to pizza</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure className="wp-caption alignright"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a3.jpeg" alt=""/><figcaption className="wp-caption-text">Networking is essential if you want to make it</figcaption></figure>
