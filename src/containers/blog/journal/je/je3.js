...
import je3Hero from '../../../../assets/img/jImage/je3/je3-hero.jpeg';
import je3a1 from '../../../../assets/img/jImage/je3/je3-a1.jpeg';
import je3a2 from '../../../../assets/img/jImage/je3/je3-a2.jpeg';
import je3a3 from '../../../../assets/img/jImage/je3/je3-a3.jpeg';

const je3 = () => {
  return (
    <div>
        {/* start page title section */}
        <section className="wow fadeIn cover-background background-position-top" style ={ { backgroundImage: `url(${ je3Hero })` } }>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure className="wp-caption alignright"><img src={ je3a1 } alt=""/><figcaption className="wp-caption-text">And lots of it</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure className="wp-caption alignleft"><img src={ je3a2 } alt=""/><figcaption className="wp-caption-text">Yahoo isn&#39;t playing around when it come to pizza</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure className="wp-caption alignright"><img src={ je3a3 } alt=""/><figcaption className="wp-caption-text">Networking is essential if you want to make it</figcaption></figure>
