...
import hero from "../../../../images/jImage/je3/je3-hero.jpeg";
import asset1 from "../../../../images/jImage/je3/je3-a1.jpeg";
import asset2 from "../../../../images/jImage/je3/je3-a2.jpeg";
import asset3 from "../../../../images/jImage/je3/je3-a3.jpeg";
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure class="wp-caption alignright"><img src={ asset1 } alt=""/><figcaption class="wp-caption-text">And lots of it</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignleft"><img src={ asset2 } alt=""/><figcaption class="wp-caption-text">Yahoo isn&#39;t playing around when it come to pizza</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignright"><img src={ asset3 } alt=""/><figcaption class="wp-caption-text">Networking is essential if you want to make it</figcaption></figure>
