            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure class="wp-caption alignright"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a1.jpeg" alt=""/><figcaption class="wp-caption-text">And lots of it</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignleft"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a2.jpeg" alt=""/><figcaption class="wp-caption-text">Yahoo isn&#39;t playing around when it come to pizza</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignright"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je3/je3-a3.jpeg" alt=""/><figcaption class="wp-caption-text">Networking is essential if you want to make it</figcaption></figure>
