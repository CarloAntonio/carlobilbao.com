...
import hero from "../../../../images/jImage/je1/je1-hero.jpg";
import asset1 from "../../../../images/jImage/je1/je1-a1.jpg";
import asset2 from "../../../../images/jImage/je1/je1-a2.jpg";
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure class="wp-caption alignright"><img src={ asset1 } alt=""/><figcaption class="wp-caption-text">Eighth grade assignment and one of my first journals.</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignleft"><img src={ asset2 } alt=""/><figcaption class="wp-caption-text">The first page of that journal, baggy clothes lyfe!</figcaption></figure>
