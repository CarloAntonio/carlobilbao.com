            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure class="wp-caption alignright"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je1/je1-a1.jpg" alt=""/><figcaption class="wp-caption-text">Eighth grade assignment and one of my first journals.</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure class="wp-caption alignleft"><img src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/jImage/je1/je1-a2.jpg" alt=""/><figcaption class="wp-caption-text">The first page of that journal, baggy clothes lyfe!</figcaption></figure>
