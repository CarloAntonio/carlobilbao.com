...
import je1hero from '../../../../assets/img/jImage/je1/je1-hero.jpg';
import je1a1 from '../../../../assets/img/jImage/je1/je1-a1.jpg';
import je1a2 from '../../../../assets/img/jImage/je1/je1-a2.jpg';

const je1 = () => {
  return (
    <div>
        {/* start page title section */}
        <section className="wow fadeIn cover-background background-position-top" style ={ { backgroundImage: `url(${ je1hero })` } }>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure className="wp-caption alignright"><img src={ je1a1 } alt=""/><figcaption className="wp-caption-text">Eighth grade assignment and one of my first journals.</figcaption></figure>
                    ...
                    <div className="col-md-10 center-col xs-text-center">
                        <figure className="wp-caption alignleft"><img src={ je1a2 } alt=""/><figcaption className="wp-caption-text">The first page of that journal, baggy clothes lyfe!</figcaption></figure>
