                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12 margin-50px-bottom last-paragraph-no-margin xs-margin-30px-bottom wow fadeInUp">
                        <div className="blog-post blog-post-style1 xs-text-center">
                            ...
                            <div className="post-details">
                                ...
                                <a href="/blog/notebook/ne/ne1" className="post-title text-medium text-extra-dark-gray width-90 display-block sm-width-100 accent-hover">Hello Notebook + First index.html File</a>
                                <div className="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb sm-margin-15px-tb"></div>
                                <p className="width-90 xs-width-100">Exploring the reasoning behind notebook and explaining html with the minimum require code to create webpage.</p>
                            </div>
                        </div>
                    </div>
                    {/* end post item */}
