            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <a href="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/nImage/ne1/ne1-snip1.png" target="_blank"><img className="alignright" src="http://d1ty8z742i6uvq.cloudfront.net/carlobilbao/img/nImage/ne1/ne1-snip1.png" alt="" style= {{width: "50%"}} /></a>
