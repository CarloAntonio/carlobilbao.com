...
import ne3s1 from '../../../../assets/img/nImage/ne3/ne3-snip1.png';
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-10 col-sm-12 col-xs-12 center-col xs-text-center">
                        ...
                        <figure className="wp-caption alignright"><a href={ ne3s1 } target="_blank" rel="noopener noreferrer"><img className="alignright" src={ ne3s1 } alt=""/></a><figcaption className="wp-caption-text">Figure 1</figcaption></figure>
